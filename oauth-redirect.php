...
define('OAUTH_CLIENT_ID', 'APP-9UN3RLQBWTJY3Z7R');//client ID
define('OAUTH_CLIENT_SECRET', '8c7aed03-f9a2-4209-b73c-a3e42129e7a3');//client secret
define('OAUTH_REDIRECT_URI', 'http://intranet.worldagroforestry.org/orcid');//redirect URI
