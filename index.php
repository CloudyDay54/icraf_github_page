  ...
  <body>
    ...
    <div class="container-narrow">
      ...
      <div class="jumbotron">
        ...
        <a class="btn btn-large" href="https://orcid.org/oauth/authorize?client_id=APP-9UN3RLQBWTJY3Z7R&response_type=code&scope=/authenticate&show_login=false&redirect_uri=http://intranet.worldagroforestry.org/orcid/"><img id="orcid-id-logo" src="https://orcid.org/sites/default/files/images/orcid_24x24.png" width='24' height='24' alt="ORCID logo"/> Create a new ORCID iD</a>
        <br> <br>
        <!--replace client_id and redirect_uri with your own values-->
        <p class="lead">Already have an ORCID iD? <a href="https://orcid.org/oauth/authorize?client_id=APP-9UN3RLQBWTJY3Z7R&response_type=code&scope=/authenticate&redirect_uri=http://intranet.worldagroforestry.org/orcid/&show_login=true">Connect your existing ORCID iD</a>
      </div>
